@extends('layouts.default', ['title' => 'create role'])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('admin.user.create.role.store', app()->getLocale())}}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control" placeholder="Name" value="{{old('name')}}" >
                                    <span style="font-style: italic; color: red; font-size: small">{{$errors->first('name')}}</span>
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="input-description">Description</label>
                                    <textarea name="description" id="input-description" cols="30" rows="10" class="form-control" placeholder="Description">{{old('description')}}</textarea>
