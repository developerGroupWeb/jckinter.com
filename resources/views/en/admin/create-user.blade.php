            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('users.index', app()->getLocale()) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="input-email" class="form-control" placeholder="Email" value="{{old('email')}}" >
