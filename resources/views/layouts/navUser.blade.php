...
<header class="header04">
    <div class="container d-flex align-items-center">
        ...
        <a href="" class="login btn btn-outline btn-round p-3"><span class="bh"></span> <span>My account</span></a>
        <a href="" class="login btn btn-default btn-round ml-3 p-3"><span class="bh"></span> <span>Log out</span></a>
    </div>
</header>
<!-- Header end -->
